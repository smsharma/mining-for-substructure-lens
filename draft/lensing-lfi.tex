...
In \citep{Stoye:2018ovl} it was shown that this ``ALICES'' loss functional is minimized by the function
%
\begin{equation}
...
\end{equation}
%
\JB{Show this explicitly in appendix.}
%
