...
\caption{Expected posterior based on a uniform prior (left) or a Gaussian prior on $\beta$ with mean $-0.9$ and standard deviation $0.1$ (right) for 20 observed lenses. The lines show a $95\%$ credible interval. We assume $\beta = -0.9$ and $\fsub = 0.05$. \JB{So far without calibration.}}
