...
\begin{figure*}
\centering
\includegraphis[width=1.\textwidth]{figures/individual_lens_predictions}
...
\caption{Left: Expected posterior and $95\%$ credible regions on subhalo mass function parameters for 100 observed lenses. The mock observations are generated for $\fsub = 0.05$ and $\beta = -0.9$. We assume a uniform prior on $\fsub$ and a Gaussian prior with mean $-0.9$ and standard deviation $0.1$ for $\beta$. Right: The pointwise median as well as 68\% and 95\% credible intervals of the subhalo mass function per host halo mass.}
