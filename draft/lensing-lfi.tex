...
\JB{Comment on novel features compared to our past gold-mining papers: marginal reference model, ``flipped'' term in loss, ResNet architecture, Bayesian inference. Where do we do this?}

\JB{Mention ``gold mining''}
...
\JB{Stress parameterized nature of network}
...
% \subsection{Individual lenses}
%
%
% \subsection{Combined likelihood}
%
%
% \subsection{Impact of simplifications}
%
%
...
\appendix
\section{Minimization of the loss functional}
\label{app:variation}
...
\end{align}
%
as claimed in Eq.~\eqref{eq:loss_minimum}. Note that this result is independent of the choise of $\pi(\theta)$, as long as this proposal distribution has support at all relevant parameter points.
