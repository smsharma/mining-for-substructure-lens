...
# sbatch train_alices_monster.sh
# sbatch train_alices_monster2.sh
...
sbatch eval_carl_exp_full.sh
sbatch eval_alices_exp_full.sh
# sbatch eval_alices_monster.sh
# sbatch eval_alices_monster_full.sh
