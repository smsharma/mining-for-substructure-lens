...
python -u train.py carl train_full carl_full_pre --load alices_fix --dir /scratch/jb6504/StrongLensing-Inference
python -u train.py carl train_full carl_full_pre_aux --load alices_fix --dir /scratch/jb6504/StrongLensing-Inference
