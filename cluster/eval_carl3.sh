...
#     echo ""
#     python -u test.py carl_${modeltag} calibrate_${tag}_theta$i carl_${modeltag}_calibrate_theta$i -z --dir /scratch/jb6504/StrongLensing-Inference
# done
#
# echo ""
# echo ""
...
# echo ""
# # python -u test.py carl_${modeltag} calibrate_${tag}_ref carl_${modeltag}_calibrate_ref -z --dir /scratch/jb6504/StrongLensing-Inference
